...
//
//    long long difference = get_target_position(ind) - ((long long)(get_motor_position(ind))<<32);
//    set_motor_speed(ind, ((KP * difference)>>32) -  ( KV * get_motor_velocity(ind) ));
   // set_motor_speed(steer1.index, speed1);
